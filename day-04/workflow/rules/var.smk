rule var:
    ...
    output:
        variability_txt = f"{config['output_dir_path']}/variability/{{sample}}_{{read_number}}_windows_var.txt",
        plot_png = f"{config['output_dir_path']}/variability/{{sample}}_{{read_number}}_var_plot.png"
    params:
        window_size = config['window_size']
    conda:
        "../env/var.yaml"
    log:
        f"{config['output_dir_path']}/variability/{{sample}}_{{read_number}}_variability.log"
    shell:
        """
